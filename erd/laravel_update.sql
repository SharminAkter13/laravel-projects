...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2025 at 07:07 AM
...
--
-- Database: `sharmino_talentstream`
--
...
('laravel-cache-ayaan@gmail.com|127.0.0.1', 'i:1;', 1762837396),
('laravel-cache-ayaan@gmail.com|127.0.0.1:timer', 'i:1762837396;', 1762837396);
...
(1, 'TechNova Systems', 'Software & Cloud Services', 'A multinational corporation specializing in enterprise cloud computing solutions and AI development.', 'https://www.technovasystems.com', '1000 Silicon Dr, San Jose, CA', 'info@technovasystems.com', '1-800-555-0199', 'technova_logo.png', 1995, '1000+ employees', '2025-11-10 06:10:04', '2025-11-10 06:10:04'),
(2, 'Nexus Financial Group', 'Financial Consulting', 'Provides expert financial planning, risk assessment, and investment strategy services to mid-market clients.', 'https://www.nexusfg.net', '45 Central Ave, New York, NY', 'contact@nexusfg.net', '1-212-555-1010', 'nexus_logo.jpg', 2008, '51-200 employees', '2025-11-10 06:10:04', '2025-11-10 06:10:04'),
(3, 'Artisan Brew Co.', 'Food & Beverage E-commerce', 'A small online retailer specializing in ethically sourced, single-origin coffee and brewing equipment.', 'https://www.artisanbrewco.com', '789 Brew St, Portland, OR', 'hello@artisanbrewco.com', '0122546565', 'artisan_logo.svg', 2020, '1-10 employees', '2025-11-10 06:10:04', '2025-11-10 22:57:59');
...
(1, 6, 8, '2025-11-08 21:38:08', '2025-11-08 21:38:08');
...
INSERT INTO `employers` (`id`, `user_id`, `company_id`, `website`, `phone`, `address`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'https://www.nexusfg.net', '1-212-555-1010', '45 Central Ave, New York, NY', '2025-10-19 21:51:46', '2025-11-10 22:09:42'),
(2, 6, 1, 'http://mishel.online', '0148586356', '4/78 los angle,usa', '2025-10-22 00:00:22', '2025-10-22 00:00:22'),
...
(1, 2, 3, '2025-11-18 03:38:00', '2026-05-16 21:38:00', 'active', '2025-11-17 21:39:09', '2025-11-17 21:49:04');
...
(1, 'sharmin@gmail.com', 1, 'Financial Manager', 1, 2, 1, 'Finance, Manager', 'Managing a company\'s financial health through activities like budgeting, financial reporting, and forecasting. Core duties include recording daily transactions, processing invoices, and reconciling accounts payable and receivable.Core duties include recording daily transactions, processing invoices, and reconciling accounts payable and receivable.', 'sharmin@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-10-25', 'it world', 'http://127.0.0.1:8000/', 'Finance', 'job_covers/DaBNigFJ6GbVb9dFzTL6slUPtJkgnh8hiH0uSqPi.jpg', 'active', '2025-10-19 22:54:25', '2025-10-31 23:39:46'),
(2, 'sharmin@gmail.com', 1, 'HRM', 2, 4, 3, 'HRM, Manager', 'Developing and implementing HR policies and procedures\nCreating strategic HR plans\nAdministering compensation and benefits programs\nActing as a liaison between upper management and employees', 'sharmin@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-10-25', 'World Tech', 'http://127.0.0.1:8000/', 'HRM', 'job_covers/5DgvW0vkZzSIzwFBqnIKbNppfb1KSde6rg47huFw.jpg', 'active', '2025-10-22 00:09:16', '2025-10-22 00:09:16'),
(3, 'mishel@gmail.com', 2, 'Software Engineer', 5, 6, 4, 'Engineer, Software Engineer', 'a professional who designs, develops, tests, and maintains software applications by applying engineering principles to create high-quality, dependable, and effective software.', 'mishel@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-11-22', 'TechWorld', 'http://127.0.0.1:8000/', 'TechWorld', 'job_covers/8nPNSIjF7HSMOsT5GeW48VEvXYecvK6Uo2U4mGUq.jpg', 'active', '2025-11-01 21:04:59', '2025-11-01 21:04:59'),
(4, 'mishel@gmail.com', 2, 'Programmer', 3, 2, 3, 'Engineer, Software Engineer', 'trrt', 'mishel@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-11-08', 'uyyu', 'http://127.0.0.1:8000/', 'hg', 'job_covers/AnJBzS8vluBtdDd1LBlrLhKbbbjYtgz9EHTEEDDW.jpg', 'active', '2025-11-01 23:45:31', '2025-11-01 23:45:31'),
(6, 'mishel@gmail.com', 2, 'Engineer', 1, 4, 4, 'Engineer, Software Engineer, Programmer', 'A programmer writes and maintains code, while a software engineer takes a broader, engineering-based approach that includes planning, designing, and testing the entire software system, not just the code itself', 'mishel@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-11-29', NULL, NULL, 'TechWorld', 'C:\\xampp\\tmp\\phpAB1.tmp', 'active', '2025-11-17 22:05:31', '2025-11-17 22:05:31'),
(7, 'mishel@gmail.com', 2, 'Programmer', 1, 4, 4, 'Engineer, Software Engineer, Programmer', 'A programmer writes and maintains code, while a software engineer takes a broader, engineering-based approach that includes the design, development, testing, and maintenance of the entire software system, not just the code. The term \"engineer\" implies a more structured and systematic process, whereas \"programmer\" focuses primarily on the coding aspect. In practice, the titles are often used interchangeably, and the actual job duties depend on the company.', 'mishel@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-12-06', 'TechNova Systems', 'https://www.technovasystems.com', 'TechWorld', 'uploads/jobs/1763439199_img-5.jpg', 'active', '2025-11-17 22:13:19', '2025-11-17 22:13:19'),
(8, 'mishel@gmail.com', 2, 'Finance Manager', 1, 4, 1, 'Finance, Manager', 'A finance manager is a professional responsible for the financial health of an organization, including managing budgets, creating financial reports, and overseeing investments. They develop and implement financial strategies, ensure compliance, manage cash flow, and provide analysis to support senior management\'s decision-making. The specific duties vary significantly depending on the size and structure of the company, ranging from comprehensive financial oversight in smaller businesses to focusing on a specific area in larger organizations.', 'mishel@gmail.com', 'http://127.0.0.1:8000/job-apply', '2025-12-05', 'TechNova Systems', 'https://www.technovasystems.com', 'Finance', 'uploads/jobs/1763441080_img-1.jpg', 'active', '2025-11-17 22:44:40', '2025-11-17 22:44:40');
...
(1, 'Bangladesh', 'Dhaka', 'Dhaka', '123 Gulshan Avenue', '1212', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(2, 'Bangladesh', 'Chattogram', 'Chattogram', '456 Agrabad Road', '4000', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(3, 'Bangladesh', 'Khulna', 'Khulna', '78 KDA Avenue', '9000', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(4, 'Bangladesh', 'Rajshahi', 'Rajshahi', '12 Shahid Abdur Rahman Street', '6000', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(5, 'Bangladesh', 'Barishal', 'Barishal', '34 College Road', '8200', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(6, 'Bangladesh', 'Sylhet', 'Sylhet', '56 Zindabazar', '3100', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(7, 'Bangladesh', 'Rangpur', 'Rangpur', '89 Rangpur Road', '5400', '2025-11-09 04:07:24', '2025-11-09 04:07:24'),
(8, 'Bangladesh', 'Mymensingh', 'Mymensingh', '23 College Gate', '2200', '2025-11-09 04:07:24', '2025-11-09 04:07:24');
...
(1, 'Govt.', 'Government Sector Jobs', 1, NULL, NULL),
(2, 'Non-Govt.', 'Non-Governmental Organization (NGO) Jobs', 1, NULL, NULL),
(3, 'Semi Govt.', 'Semi Government Sector Jobs', 1, NULL, NULL),
(4, 'Corporate', 'Private Sector Corporate Jobs', 1, NULL, NULL),
(5, 'International Agencies', 'International Agencies Sector Jobs', 1, NULL, NULL),
(6, 'Freelance', 'Independent Contract or Project-Based Jobs', 1, NULL, NULL);
...
(1, 1, 8, 'Hi i\'m Nusrat', 1, '2025-11-08 21:38:08', '2025-11-14 22:55:28'),
(2, 1, 6, 'Hello', 1, '2025-11-08 21:39:08', '2025-11-14 22:55:11'),
(3, 1, 8, 'how are you', 1, '2025-11-09 21:35:15', '2025-11-14 22:55:28'),
(4, 1, 6, 'icdgbvthgytb', 1, '2025-11-10 00:52:52', '2025-11-14 22:55:11'),
(5, 1, 6, 'icdgbvthgytb', 1, '2025-11-10 00:52:53', '2025-11-14 22:55:11'),
(6, 1, 6, 'icdgbvthgytb', 1, '2025-11-10 00:52:53', '2025-11-14 22:55:11'),
(7, 1, 6, 'icdgbvthgytb', 1, '2025-11-10 00:52:54', '2025-11-14 22:55:11'),
(8, 1, 6, 'icdgbvthgytb', 1, '2025-11-10 00:52:54', '2025-11-14 22:55:11'),
(9, 1, 8, 'ghgf', 1, '2025-11-14 22:55:19', '2025-11-14 22:55:28');
...
ALTER TABLE `jobs`
  ...
  ADD KEY `job_types_id_foreign` (`job_type_id`),
  ADD KEY `job_location_id_foreign` (`job_location_id`);
...
--
ALTER TABLE `employers`
  ADD CONSTRAINT `company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `jobs`
  ADD CONSTRAINT `job_location_id_foreign` FOREIGN KEY (`job_location_id`) REFERENCES `job_locations` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `job_types_id_foreign` FOREIGN KEY (`job_type_id`) REFERENCES `job_types` (`id`) ON DELETE SET NULL,
